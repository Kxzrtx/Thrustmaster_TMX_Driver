...
if [ "$L" == "PL" ]; then
    ...
    MSG_START_INSTALL="Naciśnij enter aby rozpocząć instalacje: "
    ...
    MSG_START_INSTALL="Presione ENTER para comenzar la instalación: "
    ...
    MSG_START_INSTALL="Appuyez sur ENTRÉE pour commencer l'installation : "
    ...
    MSG_START_INSTALL="Drücken Sie ENTER, um die Installation zu beginnen: "
else # EN
    ...
    MSG_START_INSTALL="Press ENTER to begin the installation: "
fi
